...
| 3 | Συμμετοχικό περιεχόμενο A1 |[Συμμετοχικό περιεχόμενο](https://github.com/courses-ionio/help/discussions/1239) | |
| 4 | Άσκηση γραμμής εντολών (warm up cli) |[Weather check](https://github.com/courses-ionio/help/discussions/1284) | |
